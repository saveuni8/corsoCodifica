...
<xsl:template match="/">
  <html xmlns="http://www.w3.org/1999/xhtml">
    <head>
    <link rel="stylesheet" href="style-mant.css" />
    <script>
...
function clearHighlight(id) {
  ...
  <div id="facsimile">
    <div class="image-map" id="pagina-1">
      <img src="Mantegazza-1.png" usemap="#zones1" alt="Facsimile Pagina 1" />
    ...
    <div class="image-map" id="pagina-2">
      <img src="Mantegazza-2.png" usemap="#zones2" alt="Facsimile Pagina 2" />
  ...
  <div id="testo">
              <xsl:for-each select="//tei:p">
                <p>
                  ...
                  <xsl:apply-templates select="node() except list"/>
<xsl:if test="list">
<p>
<xsl:attribute name="id">
                    <xsl:value-of select="substring(@facs, 2)"/>
